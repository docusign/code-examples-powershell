...
To use the payments code example, create a test payments gateway in your developer account. See [PAYMENTS_INSTALLATION](./PAYMENTS_INSTALLATION.md) for details.
